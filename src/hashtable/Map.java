...
public interface Map<K, V> {
  ...
  *
  * Hinweis:
  * zum Vergleich der Schluessel wird die equals-Methode verwendet
  */
   ...
   * gab, wird der alte Wert entfernt und zurueckgegeben; sonst wird null zurueckgegeben
   */
  V put(K key, V value);

  /**
   * bestimmt den Wert zu einem Schluessel in der Map @param key der Schluessel
   * @return den Wert zum Schluessel key, falls ein
   * entsprechendes Schluessel-Wert-Paar vorhanden ist; null sonst
   */
  V get(K key);
